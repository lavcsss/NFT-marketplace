class Collection < ApplicationRecord
  ...
  def update_number_of_copy
    collections = Collection.where("id != ? AND creator_id = ? AND name = ? and nft_contract_id = ?", id, creator_id, name, nft_contract_id)
    collections.update_all(no_of_copies: no_of_copies)
  end
